!(function (t, e) {
	...
	function H() {
		var t = h(x().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(
				function (t, e) {
					return (
	...
	function ft(t) {
		bn.isVisible() && gt !== t.target.value && bn.resetValidationMessage(),
			(gt = t.target.value);
	}
	function mt(t, e) {
	...
	var gt,
		...
		kt = function (t) {
			...
			pt()
				...
				: (((n = document.createElement("div")).className = J.container),
				  g && vt(n, J["no-transition"]),
				  _(n, Ct),
				  (o =
				  ...
				  (s = o),
				  "rtl" === window.getComputedStyle(s).direction && vt(C(), J.rtl),
				  (c = A()),
				  (u = bt(c, J.input)),
				  (l = bt(c, J.file)),
				  (d = c.querySelector(".".concat(J.range, " input"))),
				  (p = c.querySelector(".".concat(J.range, " output"))),
				  (f = bt(c, J.select)),
				  (m = c.querySelector(".".concat(J.checkbox, " input"))),
				  (h = bt(c, J.textarea)),
				  (u.oninput = ft),
				  (l.onchange = ft),
				  (f.onchange = ft),
	...
	function St(t, e) {
		...
		l &&
			...
			"string" == typeof (o = e.backdrop)
				...
				: o || vt([document.documentElement, document.body], J["no-backdrop"]),
			!e.backdrop &&
				e.allowOutsideClick &&
				K(
			...
			(r = e.position) in J
				...
				: (K('The "position" parameter is not valid, defaulting to "center"'),
				  vt(i, J.center)),
			(a = l),
			!(s = e.grow) || "string" != typeof s || ((c = "grow-".concat(s)) in J && vt(a, J[c])),
			z(l, e, "container"),
	...
	function Mt(t, e) {
		var n,
			...
			r,
			a,
			s = A().querySelector("#".concat(J.content));
		e.html
			? (mt(e.html, s), rt(s, "block"))
			: e.text
			? ((s.textContent = e.text), rt(s, "block"))
			: at(s),
			(n = t),
			(o = e),
			(i = A()),
			(r = Ot.innerParams.get(n)),
			(a = !r || o.input !== r.input),
	...
	function Rt(t, c) {
		...
		l >= c.progressSteps.length &&
			K(
				"Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"
			),
			c.progressSteps.forEach(function (t, e) {
				var n,
					o,
					i,
					r,
					...
					s =
						...
						vt(o, J["progress-step"]),
						_(o, n),
						o);
				u.appendChild(s),
					e === l && vt(s, J["active-progress-step"]),
					e !== c.progressSteps.length - 1 &&
						((r = c),
						(a = document.createElement("li")),
						vt(a, J["progress-step-line"]),
	...
	function Ht(t, e) {
		...
		z(l, e, "header"),
			...
			(n = t),
			(o = e),
			(r = Ot.innerParams.get(n)) && o.icon === r.icon && B()
				? Ft(B(), o)
				: (_t(),
				  o.icon &&
						(-1 !== Object.keys(X).indexOf(o.icon)
							? ((i = k(".".concat(J.icon, ".").concat(X[o.icon]))),
							  rt(i),
							  Wt(i, o),
							  Ft(i, o),
							  vt(i, o.showClass.icon))
							: Y(
			...
			(a = e),
			(s = P()),
			ct(s, a.title || a.titleText),
			a.title && mt(a.title, s),
			a.titleText && (s.innerText = a.titleText),
			z(s, a, "title"),
			(c = e),
			(u = R()),
			_(u, c.closeButtonHtml),
			z(u, c, "closeButton"),
			ct(u, c.showCloseButton),
			u.setAttribute("aria-label", c.closeButtonAriaLabel);
	}
	function Nt(t, e) {
		var n, o, i, r;
		(n = e),
	...
	var _t = function () {
		...
		Wt = function (t, e) {
			(t.textContent = ""),
				e.iconHtml
					...
					: _(t, Yt({ question: "?", warning: "!", info: "i" }[e.icon]));
		},
		Kt = function (t, e) {
			if (e.iconColor) {
		...
		Qt = function (t, e) {
			(t.className = "".concat(J.popup, " ").concat(wt(t) ? e.showClass.popup : "")),
				e.toast
					? (vt([document.documentElement, document.body], J["toast-shown"]),
					  vt(t, J.toast))
					: vt(t, J.modal),
				z(t, e, "popup"),
		...
		return new Promise(function (t) {
			...
			(oe.restoreFocusTimeout = setTimeout(function () {
				oe.previousActiveElement && oe.previousActiveElement.focus
					? (oe.previousActiveElement.focus(), (oe.previousActiveElement = null))
	...
	function ne(t) {
		for (var e in t)
			te((i = e)) || K('Unknown parameter "'.concat(i, '"')),
				t.toast &&
					((o = e),
					-1 !== se.indexOf(o) &&
						K('The parameter "'.concat(o, '" is incompatible with toasts'))),
				ee((n = e)) && g(n, ee(n));
		var n, o, i;
	}
	var oe = {},
	...
	function ue() {
		...
		e &&
			...
			yt([t.popup, t.actions], J.loading),
	...
	function ve(t, e, n, o) {
		...
		n
			...
			N() &&
				(null !== tt.previousBodyPadding &&
					((document.body.style.paddingRight = "".concat(tt.previousBodyPadding, "px")),
					(tt.previousBodyPadding = null)),
				F(document.body, J.iosfix) &&
					((i = parseInt(document.body.style.top, 10)),
					yt(document.body, J.iosfix),
					(document.body.style.top = ""),
					(document.body.scrollTop = -1 * i)),
				"undefined" != typeof window && de() && window.removeEventListener("resize", pe),
			...
			yt(
				[document.documentElement, document.body],
				[J.shown, J["height-auto"], J["no-backdrop"], J["toast-shown"], J["toast-column"]]
			);
	}
	function ye(t) {
		var e,
		...
		i &&
			((t = (function (t) {
				return void 0 !== t
					? c({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, t)
					: { isConfirmed: !1, isDenied: !1, isDismissed: !0 };
			})(t)),
			(e = Ot.innerParams.get(this)) &&
				!F(i, e.hideClass.popup) &&
				((n = ge.swalPromiseResolve.get(this)),
				yt(i, e.showClass.popup),
				vt(i, e.hideClass.popup),
				(o = C()),
				yt(o, e.showClass.backdrop),
	...
	var be = function (t, e, n) {
		...
		we = function (t, e, n, o) {
			(oe.swalCloseEventFinishedCallback = ve.bind(null, t, n, G(), o)),
				e.addEventListener(Pt, function (t) {
					t.target === e &&
						(oe.swalCloseEventFinishedCallback(),
						delete oe.swalCloseEventFinishedCallback);
				});
		},
		Ce = function (t, e) {
			setTimeout(function () {
	...
	function Ae(t) {
		...
		(e = t).inputValidator ||
			...
			((n = t).target &&
				...
				(K('Target parameter is not valid, defaulting to "body"'), (n.target = "body")),
	...
	function Se(t) {
		...
		Ne(e, n, t),
			...
			G() || oe.previousActiveElement || (oe.previousActiveElement = document.activeElement),
			Ve(n, t),
			yt(e, J["no-transition"]);
	}
	function Ee(t) {
		var e,
			n = x();
	...
	var Ve = function (t, e) {
		...
		Re = function (t, e) {
			Pt && lt(e)
				? ((t.style.overflowY = "hidden"), e.addEventListener(Pt, Ee))
		...
		Ne = function (t, e, n) {
			vt(t, n.showClass.backdrop),
				...
				n.heightAuto &&
					n.backdrop &&
					!n.toast &&
					vt([document.documentElement, document.body], J["height-auto"]);
		},
		Ue = function (t) {
				...
				? (e.disableInput(),
				  Promise.resolve()
						...
						.then(function (t) {
							e.enableButtons(),
								e.enableInput(),
								t ? e.showValidationMessage(t) : $e(e, n, o);
						}))
		...
		tn = function (t, e, n) {
			...
			o.stopKeydownPropagation && e.stopPropagation(),
				"Enter" === e.key
					...
					: "Tab" === e.key
					? nn(e, o)
					: -1 !== [].concat(Je, Xe).indexOf(e.key)
					? on(e.key)
					: -1 !== Ge.indexOf(e.key) && rn(e, o, n);
		},
		en = function (t, e, n) {
			if (
				!e.isComposing &&
		...
		on = function (t) {
			...
			-1 !== [T(), L(), q()].indexOf(document.activeElement) &&
				((e = -1 !== Je.indexOf(t) ? "nextElementSibling" : "previousElementSibling"),
		...
		ln = function (n, o, i) {
			o.container.onclick = function (t) {
				...
				sn
					? (sn = !1)
					: t.target === o.container && Q(e.allowOutsideClick) && i($.backdrop);
			};
		};
	var dn = function (t, e, n) {
		...
		fn = function (t, e) {
			return e.focusDeny && wt(t.denyButton)
				...
				: !(!e.focusConfirm || !wt(t.confirmButton)) && (t.confirmButton.focus(), !0);
		},
		mn = function () {
		...
		vn = Object.freeze({
			...
			showValidationMessage: function (t) {
				...
				o &&
					...
					o.setAttribute("aria-describedBy", J["validation-message"]),
					nt(o),
					vt(o, J.inputerror));
			},
			...
			_main: function (t) {
				ne(t),
					oe.currentInstance && oe.currentInstance._destroy(),
					(oe.currentInstance = this);
				var e = (function (t) {
			...
			update: function (e) {
				...
				Nt(this, i),
					...
					Object.defineProperties(this, {
						params: { value: c({}, this.params, e), writable: !1, enumerable: !0 },
					});
			},
			_destroy: function () {
				var t = Ot.domCache.get(this),
				...
				e &&
					(t.popup &&
						...
						(oe.swalCloseEventFinishedCallback(),
						delete oe.swalCloseEventFinishedCallback),
					oe.deferDisposalTimer &&
						(clearTimeout(oe.deferDisposalTimer), delete oe.deferDisposalTimer),
					(function (t) {
					...
					delete this.params,
					delete oe.keydownHandler,
					delete oe.keydownTarget,
					gn(Ot),
					gn(ge));
			},
		}),
